  ...
  providers: [
    Credentials({
      ...
      async authorize(credentials: unknown) {
        try {
          const response = await defaultServerInstance.post(`/api/users/login/`, {
    ...
    Credentials({
      ...
      async authorize(credentials: unknown) {
        try {
          const response = await defaultServerInstance.post(`/api/users/kakao_auth/`, { code: credentials.code });
          const data = response.data;
