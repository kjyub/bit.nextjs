...
export default class Sigungu extends AbsApiObject{
    ...
    title(): string {
        if (CommonUtils.isStringNullOrEmpty(this.sigungu)) {
            return this.sido
        }
    ...
    public get sido(): string { return this._sido }
    public get sidoEnglish(): string { return this._sidoEnglish }
    public get sidoShort(): string { return this._sidoShort }
    public get sigungu(): string { return this._sigungu }
    public get sigunguEnglish(): string { return this._sigunguEnglish }
}