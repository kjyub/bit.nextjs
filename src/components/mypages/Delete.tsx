...
export default function UserDelete() {
  ...
  return (
    <form className="flex flex-col gap-4 common-panel padding" action={submitForm}>
      <h2 className="text-xl font-bold text-surface-main-text">회원 탈퇴</h2>

      <ul className="text-sm text-surface-sub-text list-disc list-inside space-y-1">
        ...
        <li>
          서비스는 운영자 판단에 따라 기능이 변경되거나 종료될 수 있으며, 게시글 등 커뮤니티 콘텐츠의 책임은 작성자에게
          있습니다.
        </li>
      </ul>
      ...
      <button
        ...
        className={cn([
          ...
          'rounded-lg bg-surface-sub-background hover:bg-surface-sub-background-active',
          'border border-surface-common-border',
