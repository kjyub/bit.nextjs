    ...
    <div className="flex max-md:flex-col md:flex-row w-full p-4 gap-4 group">
      ...
      >
        <i
          className={cn([
            IconClassName,
            'fa-solid fa-money-bill translate-x-4 translate-y-4 mouse:group-hover:translate-x-6 mouse:group-hover:translate-y-6 group-active:translate-x-6 group-active:translate-y-6 opacity-100',
          ])}
        ></i>
        ...
        <i
          className={cn([
            IconClassName,
            'fa-solid fa-money-bill-trend-up -translate-x-4 -translate-y-4 mouse:group-hover:-translate-x-6 mouse:group-hover:-translate-y-6 group-active:-translate-x-6 group-active:-translate-y-6 opacity-80',
          ])}
        ></i>
        <div
          className={cn([
