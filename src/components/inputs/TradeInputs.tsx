  ...
  return (
    <div className="flex flex-col w-full space-y-2">
      <div className="flex justify-between items-center w-full h-9">
        ...
        <div className="flex items-center space-x-4">
          <S.InputBox
            ...
            onMouseDown={() => {
              inputValueMouseDownRef.current = true;
            }}
            onMouseUp={() => {
              inputValueMouseDownRef.current = false;
            }}
      ...
      <div className="flex flex-col w-full">
        <SlideInput value={leverageRatio} setValue={setLeverageRatio} min={1} max={maxRatio} step={1} mark={25} />
      </div>
    </div>
  );
};
    ...
    <div className="flex flex-col w-full space-y-2">
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex space-x-2">
          ...
          >
            {isShow ? <i className="fa-solid fa-square-check"></i> : <i className="fa-solid fa-square"></i>}
          </button>
      ...
      {isShow && <div className="flex flex-col w-full space-y-1">{children}</div>}
    </div>
  );
};
